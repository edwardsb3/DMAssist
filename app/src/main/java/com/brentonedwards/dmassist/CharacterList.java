...
public class CharacterList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while(index<gsonArray.length ) {
            characterData.add(new CharacterData(gsonArray[index].getName(), gsonArray[index].getType(), gsonArray[index].getChallengeRating().toString(), gsonArray[index].getAlignment()));
            index++;
        }
